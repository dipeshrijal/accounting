...
<section id="main" role="main">
    ...
    <section id="content" class="container">
        <header class="p-header">
            <h2 class="p-title">Add Categories</h2>

        </header>
        <!-- Required Feilds -->
        <div class="c-block" id="required">
            <h3 class="block-title">Required Feilds *</h3>
            {!! Form::open(['route' => 'admin.categories.store' , 'class' => 'form-validation-1-1', 'role' => 'form', 'files' => true]) !!}
                @include('admin.categories.partials.forms', ['value' => 'Submit'])
