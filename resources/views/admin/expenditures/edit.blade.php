...
<section id="main" role="main">
    ...
    <section id="content" class="container">
        ...
        <div class="c-block" id="required">
            ...
            {!! Form::model($expenditure, ['route' => ['admin.expenditures.update', $expenditure->id], 'method' => 'put', 'class' => 'form-validation-1', 'role' => 'form', 'files' => true]) !!}

                @include('admin.expenditures.partials.forms', ['value' => 'Update'])
